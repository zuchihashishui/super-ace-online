...
class GameEngineTest {
 ...
 @Test void scatterAwardAndRounding(){var g=blank();g[0][0]="A";g[1][0]="A";g[2][0]="A";var result=new GameEngine(n->123).spin(2000,g);assertEquals(8,result.freeAward());assertEquals(680,result.winCents());assertEquals(1,result.cascades().size());assertThrows(IllegalArgumentException.class,()->engine.spin(1));}
