...
import philip.emerald.ace.Utils.WalletStore;
...
public class GameService extends WalletStore {
 ...
 public GameService(JdbcTemplate db,ObjectMapper json,Accounts accounts,@Value("${ace.spin-cooldown-ms}") long cooldown){super(db,json,accounts);this.cooldown=cooldown;}
 public String activeProfile(){return rtpSettings.get(mode()).profile();}
