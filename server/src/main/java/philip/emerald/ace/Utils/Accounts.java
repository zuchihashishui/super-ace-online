...
public class Accounts {
 ...
 public static GameService.ApiError unauthorized(){return new GameService.ApiError(401,"LOGIN_REQUIRED","Vui lòng đăng nhập.");}
 ...
 public void hierarchyLock(){db.queryForObject("SELECT id FROM hierarchy_lock WHERE id=1 FOR UPDATE",Integer.class);}
